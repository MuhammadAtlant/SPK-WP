        ...
        <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="krit_muslim">4 Muslim</a>
    ...
    <h4 class="marquee-text">Selamat Datang  <?php echo $username; ?> </h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3" style="background-color:yellowgreen">
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Kriteria Kelas Muslim 4 berhasil diupdate!");</script>';
            echo '<script>window.location.href="krit_muslim.php";</script>'; 
        } else {
...
<a href="krit_muslim.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
