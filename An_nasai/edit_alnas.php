  ...
  <!-- Begin menu per murid --> 
    ...
    <h4 class="marquee-text">Selamat Datang  <?php echo $username; ?> </h4>
                ...
                <div class="container-fluid">  
                  ...
                  <h6 class="m-0 font-weight-bold" style="color: green;">Edit Data Alternatif Kelas 4 An - Nasa'i</h6>
                                </div>
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Alternatif Kelas 4 An Nasai berhasil diupdate!");</script>';
