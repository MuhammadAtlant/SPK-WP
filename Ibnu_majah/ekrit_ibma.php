    ...
    <h4 class="marquee-text">Selamat Datang  <?php echo $username; ?> </h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3" style="background-color:salmon">
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Kriteria Kelas Ibnu Majah 4 berhasil diupdate!");</script>';
            echo '<script>window.location.href="krit_ibma.php";</script>'; 
        } else {
...
<a href="krit_ibma.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
