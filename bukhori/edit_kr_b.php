        ...
        <ul class="navbar-nav bg-info sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bukhori_4.php">4 Bukhori</a>
             ...
             <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="kriteria_buk.php">4 Bukhori</a>
        ...
        <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="alter_buk.php">4 Bukhori</a>
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="analisa_buk.php">4 Bukhori</a>
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Kriteria Kelas bukhori 4 berhasil diupdate!");</script>';
            echo '<script>window.location.href="kriteria_buk.php";</script>'; 
        } else {
...
<a href="kriteria_buk.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
