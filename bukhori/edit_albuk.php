    ...
    <h4 class="marquee-text">Selamat Datang  <?php echo $username; ?> </h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                          ...
                          <h6 class="m-0 font-weight-bold" style="color: green;">Edit Data Alternatif Kelas 4 Bukhori</h6>
                                </div>
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Alternatif Kelas bukhori 4 berhasil diupdate!");</script>';
            echo '<script>window.location.href="alter_buk.php";</script>'; 
        } else {
...
<a href="alter_buk.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
