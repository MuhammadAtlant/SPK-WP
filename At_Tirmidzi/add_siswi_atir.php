                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark">Tambah Data Siswi</h6>
                                </div>
 <form method="post"> 
<div class="form-group">
<label for="nama_siswi">Nama Siswi</label>
    <input type="text" class="form-control" id="nama_siswi" name="nama_siswi" placeholder="masukkan nama siswi" required>
</div>
...
if(isset($_POST['submit'])){ 
  ...
  $kelas  = $_POST['kelas']; 
  $sql  = "INSERT INTO siswi (nama_siswi, kelas) VALUES ('$nama_siswi','$kelas')"; 
  $result = mysqli_query($connection,$sql); 
  if ($result) { 
    echo '<script>alert("Data siswi berhasil ditambahkan!");</script>';
