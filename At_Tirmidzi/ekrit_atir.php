        ...
        <ul class="navbar-nav bg-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Attirmidzi4.php">4 At_Tirmidzi</a>
        ...
        <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../At_Tirmidzi/krit_atir.php">4 An-Nasa'i</a>
                        <a class="collapse-item" href="krit_atir.php">4 At_Tirmidzi</a>
      ...
      <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="alter_atir.php">4 At_Tirmidzi</a>
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="analisa_atir.php">4 At_Tirmidzi</a>
    ...
    <h4 class="marquee-text">Selamat Datang  <?php echo $username; ?> </h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3" style="background-color:burlywood">
...
$id_kriteriaK = $_GET['id'];

// Query untuk mengambil data kriteria berdasarkan ID
$sql = "SELECT * FROM kriteria_perkelas WHERE id_kriteriaK = '$id_kriteriaK'";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Query untuk memperbarui data kriteria kelas
        $update_sql = "UPDATE kriteria_perkelas 
        SET nama_kriteria = '$nama_kriteria', 
        tingkat_kepentingan = '$tingkat_kepentingan',
        cost_benefit = '$cost_benefit' WHERE id_kriteriaK = '$id_kriteriaK'";
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Kriteria Kelas At-Tirmidzi 4 berhasil diupdate!");</script>';
            echo '<script>window.location.href="krit_atir.php";</script>'; 
        } else {
...
<div class="form-group">
  <label for="id_kriteriaK">ID Kriteria</label>
  <input type="text" class="form-control" id="id_kriteriaK" name="id_kriteriaK"  
  value="<?php echo $row['id_kriteriaK']; ?>" readonly>
</div>
...
<div class="form-group">
  ...
  <select class="form-control" name="tingkat_kepentingan" id="tingkat_kepentingan">
    <option value='1' <?php if($row["tingkat_kepentingan"]=='1') echo "selected"?>>1 - (TP) Tidak Penting</option>
    <option value='2' <?php if($row["tingkat_kepentingan"]=='2') echo "selected"?>>2 - (KP) Kurang Penting</option>
    <option value='3' <?php if($row["tingkat_kepentingan"]=='3') echo "selected"?>>3 - (CP) Cukup Penting</option>
    <option value='4' <?php if($row["tingkat_kepentingan"]=='4') echo "selected"?>>4 - (P) Penting</option>
    <option value='5' <?php if($row["tingkat_kepentingan"]=='5') echo "selected"?>>5 - (SP) Sangat Penting</option>
    </select>
</div>
...
<a href="krit_atir.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
