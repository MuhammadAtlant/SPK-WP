                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark">Edit Data Siswi</h6>
                                </div>
...
// Query untuk mengambil data siswi berdasarkan ID
$sql = "SELECT * FROM siswi WHERE id_siswi = '$id_siswi'";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $nama_siswi = $_POST['nama_siswi'];
        $kelas = $_POST['kelas'];

       
        $update_sql = "UPDATE siswi SET nama_siswi = '$nama_siswi', kelas = '$kelas' 
        WHERE id_siswi = '$id_siswi'";
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data siswi berhasil diupdate!");</script>';
            echo '<script>window.location.href="Attirmidzi4.php";</script>'; 
        } else {
...
<div class="form-group">
  <label for="id_siswi">ID Siswi</label>
  <input type="text" class="form-control" id="id_siswi" name="id_siswi"  value="<?php echo $row['id_siswi']; ?>" readonly>
</div>

<div class="form-group">
<label for="nama_siswi">Nama Siswi</label>
    <input type="text" class="form-control" id="nama_siswi" name="nama_siswi" 
    value="<?php echo $row['nama_siswi']; ?>">
</div>
...
<a href="Attirmidzi4.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>

        <?php
} else {
    echo "Data siswi tidak ditemukan.";
}
?>
