                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark">Tambah Data Wali Kelas</h6>
                                </div>
 <form method="post"> 
<div class="form-group">
<label for="nama_walas">Nama Wali Kelas</label>
    <input type="text" class="form-control" id="nama_walas" name="nama_walas" placeholder="masukkan nama wali kelas" required>
</div>

<div class="form-group">
  <label for="pend_terakhir">Pendidikan Terakhir</label>
  <input type="text" class="form-control" id="pend_terakhir" name="pend_terakhir" placeholder="masukkan pendidikan terakhir" required>
</div>
...
if(isset($_POST['submit'])){ 
  ...
  $sql  = "INSERT INTO walas (nama_walas, pend_terakhir, nama_kelas) VALUES ('$nama_walas','$pend_terakhir','$nama_kelas')"; 
  $result = mysqli_query($connection,$sql); 
  if ($result) { 
    echo '<script>alert("Data wali kelas berhasil ditambahkan!");</script>';
