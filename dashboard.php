...
<head>
    ...
    <link href="assets/vendor/fontawesome-free/css/fontawesome.min.css" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
 ...
 <!-- The end of menu per kelas -->
  ...
  <!-- Running Text sesuai dengan user yang sudah login -->
    ...
    <h4 class="marquee-text">Selamat Datang  <?php echo $username; ?> </h4>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <!-- Dropdown - User Informasi dan Tombol Logout -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                                    <iP class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Logout
                                </a>
                            </div>
                        </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Dashboard SPK Menentukan Siswa Siswi Berprestasi Dengan Metode WP</h6>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <!-- Illustrations -->
                            <div class="card shadow mb-4 md-10">
                                <div class="card-header py-6">
                                    <h6 class="m-0 font-weight-bold text-primary">Sejarah Singkat</h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-1 px-sm-4 mt-1 mb-2" style="width: 300px; height:300px;"
                                            src="assets/img/logoabudzar.png" alt="...">
                                    </div>
                                    <p>SD Islam Abu Dzar  berdiri pada tahun 2010 dan berada di bawah naungan Yayasan Abu Dzar. 
                                    Pada saat pertama kali dibangun, 
                                    SD Islam Abu Dzar berlokasi di JL. Raya Jombang No.93 RT.04/RW.06 Kel.Jombang, Kec.Ciputat, Tangerang Selatan</p>
                                    
                                    <p>Setelah Empat tahun berdiri, tepatnya pada tahun 2014,  SD Islam Abu Dzar pindah lokasi ke Jl. Sumatera Gg. Haji Bakrie 003/007 
                                    Rawa Lele Jombang Ciputat Tangerang Selatan di atas sebidang tanah seluas 3000 M2</p>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Visi Dan Misi SDI Abu Dzar</h6>
                                </div>
                                <div class="card-body">
                                    <h2>Visi</h2>
                                    ...
                                    <h2>Misi</h2>
                                    <ol>
                                        <li>Mencetak generasi rabbani yang cinta kepada Allah dan Rasul-Nya,
                                            serta berpegang teguh kepada Al-Quran dan As-Sunnah sesuai pemahaman salafu ummah.
                                        </li>
                                        <li>Menumbuhkan kesadaran beribadah dan berakhlaqul karimah. 
                                        </li>
                                        <li>Mampu membaca dan menghafali Al-Quran dengan baik dan benar.
                                        </li>
                                        <li>Memahami dan menghayati, dan mengamalkan ilmu agama.
                                        </li>
                                        <li>Memahami bahasa Arab dasar dan lanjutan serta pengetahuan umum.
                                        </li>
                                        <li>Mengembangkan potensi anak secara optimal sesuai dengan bakat dan minat
                                        </li>
                                    </ol>
                            </div>
