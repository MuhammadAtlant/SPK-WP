...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Kriteria Kelas Al Bayhaqi 4 berhasil diupdate!");</script>';
            echo '<script>window.location.href="krit_albay.php";</script>'; 
        } else {
...
<a href="krit_albay.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
