            ...
            <li class="nav-item">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="krit_akhwat.php">Kriteria Murid Akhwat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="alter_akhwat.php">Alternatif Murid Akhwat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="analisa_akh.php">Hasil Murid Akhwat</a>
                    </div>
                </div>
            </li>
    ...
    <h4 class="marquee-text">Selamat Datang  <?php echo $username; ?> </h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3" style="background-color:springgreen">
                          <h6 class="m-0 font-weight-bold text-center" style="color:chocolate;">Edit Data Alternatif Murid Ikhwan</h6>
                                </div>
...
include "../backend/koneksi.php";
 ...
 // Ambil data kriteria
 $sql_kriteria = "SELECT nama_kriteria FROM kriteria_akhwat";
...
// Ambil ID alternatif ikhwan yang akan diedit 
$id_alt_akh = $_GET['id'];

// Query untuk mengambil data alternatif berdasarkan ID
$sql = "SELECT * FROM alternatif_akhwat WHERE id_alt_akh = '$id_alt_akh'";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Query untuk memperbarui data alternatif akhwat
        $update_sql = "UPDATE alternatif_akhwat
        ...
        C3 = '$C3',
        C4 = '$C4',
        C5 = '$C5' WHERE id_alt_akh = '$id_alt_akh'";
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Alternatif Murid Akhwat berhasil diupdate!");</script>';
            echo '<script>window.location.href="alter_akhwat.php";</script>'; 
        } else {
...
<div class="form-group">
  <label for="id_alt_akh">ID Alternatif </label>
  <input type="text" class="form-control" id="id_alt_akh" name="id_alt_akh"  
  value="<?php echo $row['id_alt_akh']; ?>" readonly>
</div>

<div class="form-group">
<label for="nama_alter">Nama Alternatif</label>
<input type="text" class="form-control" id="nama_alternatif" name="nama_alternatif"  
  value="<?php echo $row['nama_alternatif']; ?>" readonly>
</div>

<div class="form-group">
<label for="id_alterK">Id Alternatif Per Kelas</label>
<input type="text" class="form-control" id="id_alterK" name="id_alterK"  
  value="<?php echo $row['id_alterK']; ?>" readonly>
</div>

<div class="form-group">
<label for="asl_kls">Asal Kelas</label> 
    <input type="text" class="form-control" id="asal_kelas" name="asal_kelas" 
    value="<?php echo $row['asal_kelas']; ?>">
</div>
...
<a href="alter_akhwat.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
