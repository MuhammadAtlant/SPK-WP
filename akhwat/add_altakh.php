    ...
    <h4 class="marquee-text">Selamat Datang<?php echo $username;?></h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3" style="background-color:plum">
                                <h6 class="m-0 font-weight-bold text-center" style="color: black;">Tambah Data Alternatif Murid Akhwat</h6>
                                </div>
...
<select class="form-control" name="nama_alternatif" aria-label="Default select example"> 
<?php 
    include "../backend/koneksi.php";
    $sql = "SELECT * from alter_perkelas";
...
<select class="form-control" name="id_alterK" aria-label="Default select example"> 
<?php 
    include "../backend/koneksi.php";
    $sql = "SELECT * from alter_perkelas";
    $result = mysqli_query($connection,$sql);
    while ($row = mysqli_fetch_array($result)){
        echo "<option value='$row[id_alterK]'>$row[id_alterK]</option>";
    }
    ?>
      </select> 
</div>
...
<div class="form-group">
  ...
  <select class="form-control" name="asal_kelas" aria-label="Default select example"> 
...
if(isset($_POST['submit'])){ 
  ...
  $C4  = $_POST['C4'];
  $C5  = $_POST['C5'];
  $sql  = "INSERT INTO alternatif_akhwat (nama_alternatif, id_alterK, asal_kelas, C1, C2, C3, C4, C5) 
           VALUES ('$nama_alternatif','$id_alterK','$asal_kelas','$C1','$C2','$C3','$C4','$C5')"; 
  $result = mysqli_query($connection,$sql); 
  if ($result) { 
