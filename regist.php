                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="backend/regist_log.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-user" id="password" name="password"
                                        placeholder="Masukkan Passwrod Anda" required>
                                </div>
                                <div class="form-group">
  <label for="role">Role</label>
  <select class="form-control" name="role" aria-label="Default select example"> 
        <option value="Walas Bukhori">Walas Bukhori</option> 
        <option value="Walas Muslim">Walas Muslim</option> 
        <option value="Walas Abu Dawud">Walas Abu Dawud</option> 
        <option value="Walas Al Bayhaqi">Walas Al Bayhaqi</option> 
        <option value="Walas An Nasai">Walas An-Nasa'i</option> 
        <option value="Walas At Tirmidzi">Walas At Tirmidzi</option> 
        <option value="Walas Ibnu Majah">Walas Ibnu Majah</option> 
      </select> 
</div>
