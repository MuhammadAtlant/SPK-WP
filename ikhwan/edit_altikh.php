...
include "../backend/koneksi.php";
 ...
 // Ambil data kriteria
 $sql_kriteria = "SELECT nama_kriteria FROM kriteria_ikhwan";
...
$sql = "SELECT * FROM alternatif_ikhwan WHERE id_alt_ikh = '$id_alt_ikh'";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Query untuk memperbarui data alternatif ikhwan
        $update_sql = "UPDATE alternatif_ikhwan
        ...
        C3 = '$C3',
        C4 = '$C4',
        C5 = '$C5' WHERE id_alt_ikh = '$id_alt_ikh'";
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Alternatif Murid Ikhwan berhasil diupdate!");</script>';
            echo '<script>window.location.href="alter_ikhwan.php";</script>'; 
        } else {
...
<div class="form-group">
  <label for="id_alt_ikh">ID Alternatif </label>
  <input type="text" class="form-control" id="id_alt_ikh" name="id_alt_ikh"  
  value="<?php echo $row['id_alt_ikh']; ?>" readonly>
</div>
...
<label for="asl_kls">Asal Kelas</label> 
    <input type="text" class="form-control" id="asl_kls" name="asl_kls" 
    value="<?php echo $row['asl_kls']; ?>">
</div>
...
<a href="alter_ikhwan.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
