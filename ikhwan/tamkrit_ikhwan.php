    ...
    <h4 class="marquee-text">Selamat Datang<?php echo $username;?></h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3" style="background-color:silver">
                                <h6 class="m-0 font-weight-bold text-center">Tambah Kriteria Murid Ikhwan</h6>
                                </div>
 <form method="post"> 
...
if(isset($_POST['submit'])){ 
  ...
  $sql  = "INSERT INTO kriteria_ikhwan (nama_kriteria, t_kepentingan, cost_benefit) 
           VALUES ('$nama_kriteria','$t_kepentingan','$cost_benefit')"; 
