    ...
    <h4 class="marquee-text">Selamat Datang<?php echo $username;?></h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                ...
                                <h6 class="m-0 font-weight-bold text-center" style="color: black;">Tambah Data Alternatif Murid Ikhwan</h6>
                                </div>
...
<div class="form-group">
  ...
  <select class="form-control" name="asl_kls" aria-label="Default select example"> 
...
if(isset($_POST['submit'])){ 
  ...
  $C4  = $_POST['C4'];
  $C5  = $_POST['C5'];
  $sql  = "INSERT INTO alternatif_ikhwan (nama_alternatif, id_alterK, asl_kls, C1, C2, C3, C4, C5) 
           VALUES ('$nama_alternatif','$id_alterK','$asl_kls','$C1','$C2','$C3','$C4','$C5')"; 
  $result = mysqli_query($connection,$sql); 
  if ($result) { 
