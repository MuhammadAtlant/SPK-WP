...
// Ambil ID siswa yang akan diedit (biasanya dari URL atau parameter lain)
$id_siswa = $_GET['id'];
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $update_sql = "UPDATE siswa SET nama_siswa = '$nama_siswa', kelas = '$kelas' 
...
<div class="form-group">
  ...
  <input type="text" class="form-control" id="id_siswa" name="id_siswa"  value="<?php echo $row['id_siswa']; ?>" readonly>
</div>
