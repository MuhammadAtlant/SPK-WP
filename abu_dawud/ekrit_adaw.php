        ...
        <ul class="navbar-nav bg-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="abu_dawud4.php">4 Abu Dawud</a>
        ...
        <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../Muslim/krit_muslim">4 Muslim</a>
                        <a class="collapse-item" href="krit_adaw.php">4 Abu Dawud</a>
     ...
     <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="alter_adaw.php">4 Abu Dawud</a>
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionSidebar">
                    <div class="bg-gradient-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="analisa_adaw.php">4 Abu Dawud</a>
    ...
    <h4 class="marquee-text">Selamat Datang  <?php echo $username; ?> </h4>
                ...
                <div class="container-fluid">  
                     ...
                     <div class="card shadow mb-4">
                                <div class="card-header py-3" style="background-color:chocolate">
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (mysqli_query($connection, $update_sql)) {
            echo '<script>alert("Data Kriteria Kelas Abu Dawud 4 berhasil diupdate!");</script>';
            echo '<script>window.location.href="krit_adaw.php";</script>'; 
        } else {
...
<a href="krit_adaw.php" type="cancel" class="btn btn-warning">Kembali</a>
        </form>
